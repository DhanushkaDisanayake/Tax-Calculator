...
The Tax Calculator System provides a user-friendly console menu that allows users to select tax calculation options such as:

- Withholding Tax
- Payable Tax
- Income Tax
- SSCL
- Leasing Payment Calculations
...
Supports calculation of withholding tax for:
